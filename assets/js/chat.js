...
const CONTACTS_KEY = "riseup_contacts";
const currentEmail = String(user?.email || "").trim().toLowerCase();
let directory = [];
let contacts = [];
let activeContact = null;
const nicknames = JSON.parse(localStorage.getItem("riseup_nicknames") || "{}");
